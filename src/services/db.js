...
function seedSchedules() {
  const doctors = ['u_doc01', 'u_doc02', 'u_doc03', 'u_doc04'];
...
function seedReservations() {
  return [
    {
      id: 'res_1',
      deviceId: 'dev_pre_002',
      doctorId: 'u_doc02',
      patientName: '',
      timeRange: '2026-08-18 09:00 - 10:00',
      purpose: '超声心动检查',
